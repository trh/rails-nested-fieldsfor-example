...
describe DomainsController do
  ...
  let(:valid_attributes) { { "domain_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved domain as @domain" do
        ...
        post :create, {:domain => { "domain_name" => "invalid value" }}, valid_session
        assigns(:domain).should be_a_new(Domain)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested domain" do
        ...
        Domain.any_instance.should_receive(:update).with({ "domain_name" => "MyString" })
        put :update, {:id => domain.to_param, :domain => { "domain_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the domain as @domain" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Domain.any_instance.stub(:save).and_return(false)
        put :update, {:id => domain.to_param, :domain => { "domain_name" => "invalid value" }}, valid_session
        assigns(:domain).should eq(domain)
      end
